...
// تحديث: 14 يناير 2026 - دفعة اليوم فقط
...
const dateStr = "الأربعاء 14 يناير 2026 | 25 رجب 1447 - 02:00 م";
...
const udemyCourses = [
    {
        ...
        desc: "كيف تلتزم بالكتابة اليومية وتطور مهاراتك الإبداعية.",
        cat: "Business",
    ...
    {
        id: 1610,
        titleAr: "إكسل للمحاسبين والباحثين عن عمل",
        titleEn: "MS Excel Masterclass for Job Seekers Accounting Success",
        desc: "تطبيقات محاسبية عملية باستخدام الإكسل.",
        cat: "Office Productivity",
        subCat: "Microsoft",
        date: dateStr,
    ...
    },
    {
        ...
        subCat: "Microsoft",
        date: dateStr,
        img: "https://placehold.co/600x400/16a34a/ffffff?text=Data+Excel",
