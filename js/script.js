...
function initGalleryPage() { 
    ...
    if(loadMoreBtn) {
        // نستخدم onclick عشان نضمن مفيش تكرار للـ listeners
...
function renderGallery() {
    ...
    // إضافة رقم عشوائي (timestamp) لرابط الصورة عشان يكسر الكاش
    // ده بيخلي المتصفح يروح يتأكد من السيرفر لو الصورة موجودة فعلاً
